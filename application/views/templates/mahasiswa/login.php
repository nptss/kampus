    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="">LOGIN RUANG DOSEN WALI</a>
            </div>
    ...
    <div class="row">
      <div class="col-md-5 col-md-offset-4">
        <div class="loginkan">
          ...
          <br />
          <a href="<?=site_url('')?>">
            <button type="button" class="form-control btn btn-primary" name="button">Kembali</button>
          </a>
          <br /><br>
          <input type="text" class="form-control user" oninput="validasi()" name="" value="" placeholder="NIM">
          <br />
...
function masuk(){
  ...
  $.ajax({
    type: "POST",
    data: "nim="+user+"&pass="+pass,
    url : "<?=base_url('mahasiswa/masuk')?>",
    success:function(data){
      if(data=="OK"){
        window.location.replace("<?=base_url('front_mhs/internal')?>");
      }
      else{
        alert(data);
      }
