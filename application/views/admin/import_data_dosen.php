...
<div class="row">
  <div class="col-md-12">
    <div class="row">
      <div class="col-md-5">
        <div id="kotakan">
          <h5 class="text-center">Silahkan pilih data Excel Dosen !</h5>
          <form name="myForm" id="myForm" onSubmit="return validateForm()" action="<?=base_url('import/simpan_dosen.php')?>" method="post" enctype="multipart/form-data">
